...
@Component({
  selector: "table-filter-control",
  templateUrl: "./table-filter-control.component.html",
  styleUrls: ["./table-filter-control.component.scss"]
})
export class TableFilterControlComponent implements OnInit {
  constructor() {}
