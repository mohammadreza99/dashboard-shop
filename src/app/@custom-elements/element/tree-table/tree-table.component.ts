...
import { TableAction } from '../../model/table-action.model';
import { TreeTable } from '../../model/tree-table.model';
...
export class TreeTableComponent implements OnInit, OnChanges {
  ...
  @Input() selectionMode: TreeSelectionMode = null;
