...
import { ExtraField } from "src/app/Models/product.model";
import { Observable } from "rxjs";
import { ResponseModel } from "src/app/Models/response.model";
import { Tree } from 'src/app/@custom-elements/model/tree.model';

@Component({
  selector: "product-extra-field-add-or-edit-page",
  templateUrl: "./product-extra-field-add-or-edit.page.html",
  styleUrls: ["./product-extra-field-add-or-edit.page.scss"]
})
export class ProductExtraFieldAddOrEditPage implements OnInit {
  constructor(
